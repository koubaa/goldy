...
use goldy_ffi::{
    ...
    goldy_scheme_submit, goldy_texture_destroy, GoldyColor, GoldyDepthFormat, GoldyResult, GoldyTargetLoad,
    GoldyTextureFlags, GoldyTextureFormat, GoldyTextureKind,
};
use std::ffi::CString;
