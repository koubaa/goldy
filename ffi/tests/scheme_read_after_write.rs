...
use goldy_ffi::{
    ...
    goldy_context_create, goldy_context_destroy, goldy_instance_destroy, goldy_memory_exchange_create,
    goldy_memory_exchange_destroy, goldy_parcel_destroy, goldy_runtime_acquire_buffer, goldy_runtime_destroy,
    goldy_scheme_compute_node_begin, goldy_scheme_compute_node_dispatch, goldy_scheme_compute_node_with_parcel,
    goldy_scheme_create, goldy_scheme_destroy, goldy_scheme_submission_destroy, goldy_scheme_submit,
...
fn scheme_read_after_acquire_then_copy() {
    unsafe {
        ...
        let src = goldy_runtime_acquire_buffer(
            device,
        ...
        let dst = goldy_runtime_acquire_buffer(device, 64 * 4, GoldyBufferKind::Scattered, 0, std::ptr::null(), 0);
