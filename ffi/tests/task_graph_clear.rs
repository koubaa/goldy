...
use goldy_ffi::{
    ...
    goldy_task_graph_render_pass_clear, goldy_task_graph_render_pass_finish, GoldyAdapterInfo,
    GoldyColor, GoldyDevice, GoldyDeviceType, GoldyInstance, GoldyResult, GoldyTextureFormat,
};
use std::ffi::CStr;
