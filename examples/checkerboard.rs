...
use goldy::{
    shaders, BufferFlags, BufferKind, Color, DeviceDescriptor, Instance, LayoutCheckable, NodeAccess, Parcel,
...
impl App {
    ...
    fn render_frame(&mut self) -> anyhow::Result<()> {
        ...
        let mut pass = self.frame_graph.render_pass("checkerboard", scene_rt);
