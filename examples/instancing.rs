...
impl RenderState {
    fn new(window: Arc<Window>) -> Result<Self> {
        ...
        let instance_buffer = device.alloc_buffer_with_data(&instances, DataAccess::Scattered)?;
        ...
        let params_buffer = device.alloc_buffer_with_data(&[params], DataAccess::Broadcast)?;
