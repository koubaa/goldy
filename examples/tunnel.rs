...
use goldy::{
    shaders, Buffer, BufferFlags, BufferKind, Color, DeviceDescriptor, Grant, Instance, Lease,
...
impl App {
    ...
    fn record_scheme(
        ...
        let mut pass = scheme.render_pass("tunnel", scene_rt);
                ...
                event_loop
                    .create_window(
                        Window::default_attributes()
                            .with_title("Goldy - Tunnel Effect (Scheme + Present)")
