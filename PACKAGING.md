...
Goldy requires a specific version of [Slang](https://github.com/shader-slang/slang) (currently **2026.13**) for SM 6.6 bindless support. Without bundling, users may encounter runtime failures because:
