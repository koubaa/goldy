...
/// <summary>
/// Create a Goldy <see cref="SwapchainPool"/> from a GLFW window (cross-platform).
/// </summary>
internal static class GlfwSwapchainPool
{
    public static unsafe SwapchainPool Create(Context ctx, WindowHandle* window)
    {
        ...
        if (OperatingSystem.IsWindows())
        {
            ...
            return SwapchainPool.CreateWin32(ctx, hwnd);
        }
        ...
        if (OperatingSystem.IsMacOS())
        {
            ...
            return SwapchainPool.CreateAppKit(ctx, nsView);
        }
        ...
        if (OperatingSystem.IsLinux())
        {
            ...
            return SwapchainPool.CreateWayland(ctx, display, surface);
        }

        throw new PlatformNotSupportedException("Unsupported OS for GLFW swapchain pool creation");
    }
