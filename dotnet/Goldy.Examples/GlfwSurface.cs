...
/// <summary>
/// Create a Goldy <see cref="Surface"/> from a GLFW window (cross-platform).
/// </summary>
internal static class GlfwSurface
{
    public static unsafe Surface Create(Device device, WindowHandle* window)
    {
        ...
        if (OperatingSystem.IsWindows())
        {
            ...
            return Surface.CreateWin32(device, hwnd);
        }
        ...
        if (OperatingSystem.IsMacOS())
        {
            ...
            return Surface.CreateAppKit(device, nsView);
        }
        ...
        if (OperatingSystem.IsLinux())
        {
            ...
            return Surface.CreateWayland(device, display, surface);
        }

        throw new PlatformNotSupportedException("Unsupported OS for GLFW surface creation");
    }
