...
impl crate::backend::GpuBackendPresentSplit for VulkanBackend {
    ...
    fn schedule_present_on_submission_worker(
        ...
        let present_tv = present_split::schedule_present_on_submission_worker(&mut self.state, frame, submit_tv)?;
...
impl GpuBackend for VulkanBackend {
    ...
    fn destroy_texture(&mut self, texture_handle: TextureHandle) {
        texture::destroy(&self.state.devices, &self.state.textures, texture_handle);
    }
