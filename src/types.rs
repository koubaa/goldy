...
///
/// When creating buffers with [`crate::Runtime::acquire_buffer_with_data`], the inferred
...
/// [`crate::Runtime::acquire_buffer`] with an explicit element stride.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Default)]
pub enum BufferKind {
    ...
    /// [`crate::Runtime::acquire_buffer_with_data`], [`crate::Runtime::acquire_buffer`], etc.).
    ///
