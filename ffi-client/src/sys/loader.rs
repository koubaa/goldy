...
pub(crate) struct GoldyFfi {
    ...
    pub goldy_runtime_adapter_id: FnGoldyRuntimeAdapterId,
    pub goldy_runtime_destroy: FnGoldyRuntimeDestroy,
    pub goldy_runtime_has_library: FnGoldyRuntimeHasLibrary,
    pub goldy_runtime_is_valid: FnGoldyRuntimeIsValid,
    ...
    pub goldy_instance_create_runtime_for_adapter: FnGoldyInstanceCreateDeviceForAdapter,
    ...
    pub goldy_runtime_acquire_buffer: FnGoldyRuntimeAcquireBuffer,
    ...
    pub goldy_runtime_acquire_texture: FnGoldyRuntimeAcquireTexture,
...
impl GoldyFfi {
    fn load() -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            goldy_runtime_adapter_id: sym!("goldy_runtime_adapter_id", FnGoldyRuntimeAdapterId),
            goldy_runtime_destroy: sym!("goldy_runtime_destroy", FnGoldyRuntimeDestroy),
            goldy_runtime_has_library: sym!("goldy_runtime_has_library", FnGoldyRuntimeHasLibrary),
            goldy_runtime_is_valid: sym!("goldy_runtime_is_valid", FnGoldyRuntimeIsValid),
            ...
            goldy_instance_create_runtime_for_adapter: sym!(
                "goldy_instance_create_runtime_for_adapter",
            ...
            goldy_runtime_acquire_buffer: sym!("goldy_runtime_acquire_buffer", FnGoldyRuntimeAcquireBuffer),
            ...
            goldy_runtime_acquire_texture: sym!("goldy_runtime_acquire_texture", FnGoldyRuntimeAcquireTexture),
